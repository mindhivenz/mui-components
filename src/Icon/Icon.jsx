...
export const AssignmentTurnedInIcon = namedIcon(ASSIGNMENT_TURNED_IN)
...
export const FileDownloadIcon = namedIcon(FILE_DOWNLOAD)
...
export const LastPage = namedIcon(LAST_PAGE)
...
export const SchoolIcon = namedIcon(SCHOOL)
